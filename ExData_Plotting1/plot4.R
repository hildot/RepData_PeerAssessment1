## H. Dotson's code to produce plot4.png for Course Project 1
...
plot(epconsub$Voltage, type = "l", xlab = "datetime", ylab = "Voltage",
     ylim = c(234, 247), xaxt = "n")
axis(1, at = c(1, 1441, 2881), labels = c("Thu", "Fri", "Sat"))
...
## Bottom right plot ##
plot(epconsub$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power",
     ylim = c(0.0, 0.5), xaxt = "n")
axis(1, at = c(1, 1441, 2881), labels = c("Thu", "Fri", "Sat"))
